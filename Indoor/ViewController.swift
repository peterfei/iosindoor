...
//  Indoor
//
//  Created by peterfei on 16/9/19.
...
class ViewController: UIViewController, IALocationManagerDelegate, MKMapViewDelegate  {
    ...
    override func viewDidLoad() {
        ...
        SVProgressHUD.showWithStatus(NSLocalizedString("正在加载中...", comment: ""))
    }
